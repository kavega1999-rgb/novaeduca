...
const Dashboard = () => {
  ...
  const isSubRoute = ["/dashboard/reports", "/dashboard/users", "/dashboard/trainings", "/dashboard/overview", "/dashboard/adherence", "/dashboard/attendance"].includes(location.pathname);
